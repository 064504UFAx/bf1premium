...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Cazux Hub BF Premium') then
        makefolder('Cazux Hub BF Premium')
    end
    if not _G.Dis and not isfile('Cazux Hub BF Premium/'..Name..'.json') then
        writefile('Cazux BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Cazux Hub BF Premium') and isfile('Cazux Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Cazux Hub BF Premium/'..Name..'.json'))
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('Cazux Hub BF Premium') and isfile('Cazux Hub BF Premium/'..Name..'.json') then
        writefile('Cazux Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
	elseif not _G.Dis then
        Check_Setting(Name)
    end
end
...
local win = library:Window("Cazux",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
